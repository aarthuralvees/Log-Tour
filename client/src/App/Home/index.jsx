  ...
  return (
    <div className='bg-background min-h-screen relative'>
      ...
      <button
        ...
        className='absolute top-4 right-4 bg-white rounded-full px-6 py-2 border-2 border-borrow text-borrow hover:bg-borrow hover:text-white shadow-md transition-all'
      >
        Login
      </button>
      ...
      <div className="Hero flex items-center justify-center text-center px-4 gap-2">
        ...
        <div className='TextoHero flex flex-col items-center gap-4 mt-16'>
          <h2 className='font-rokkitt font-bold text-slate-900 text-5xl'>
          ...
          <CustomButton
            ...
            variant="white"
            width='w-auto'
            className='bg-white rounded-full px-6 py-2 border-2 border-borrow text-borrow scale-150 hover:bg-borrow shadow-md hover:text-white transition-all'
      ...
      <div className='Section p-6 mt-10 text-center relative'>
        ...
        <div className="relative w-full flex justify-center items-center">
          <div
            className="absolute inset-x-20 top-10 bottom-10 border-4 border-blue-300 rounded-3xl z-0 scale-50"
          ></div>
